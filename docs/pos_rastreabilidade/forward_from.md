...
Já os requisitos funcionais obtidos a partir da técnica de [Observação](../elicitacao/tecnicas/observacao.md) serão rastreados conforme apresentado na Tabela 2 abaixo:
...
<h6 align = "center"> Tabela 2: Forward-From de Requisitos obtidos a partir de Observação
<br> Autor: Brunna Louise</h6>
...
| ------ | ---- | 
| Épico  | [EP01 - Conteúdo](../modelagem/backlog.md#311-ep01-conteudo) |
| Feature | Assistir a uma live |
| História de Usuário | [USB01](../modelagem/user_stories.md#USB01) |
| Caso de Uso | [Consumir Conteúdo](../modelagem/usecase.md#53-caso-de-uso-consumir-conteudo) |
| Cenário  | [C06](../modelagem/cenarios.md#c06-assistir-uma-live)  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/assistir_live.mkv" type="video/mp4"></video> |
...
| História de Usuário | [USB02](../modelagem/user_stories.md#USB02) |
| Caso de Uso | [Consumir Conteúdo](../modelagem/usecase.md#53-caso-de-uso-consumir-conteudo) |
| Cenário  | [C06](../modelagem/cenarios.md#c06-assistir-uma-live)  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/assistir_vod.mkv" type="video/mp4"></video> |
...
| História de Usuário | [USB03](../modelagem/user_stories.md#USB03) |
| Caso de Uso | [Interagir em Lives](../modelagem/usecase.md#56-caso-de-uso-interagir-em-lives) |
| Cenário  | -  |
| Funcionalidade |<video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/comentar_live.mkv" type="video/mp4"></video>|
...
| História de Usuário | [USB18](../modelagem/user_stories.md#USB18) |
| Caso de Uso | [Apoiar Conteúdo](../modelagem/usecase.md#58-caso-de-uso-apoiar-conteudo) |
| Cenário  | -  |
...
| História de Usuário | [USB20](../modelagem/user_stories.md#USB20) |
| Caso de Uso | [Apoiar Conteúdo](../modelagem/usecase.md#58-caso-de-uso-apoiar-conteudo) |
| Cenário  | -  |
...
| História de Usuário | [USB10](../modelagem/user_stories.md#USB10) |
| Caso de Uso | - |
| Cenário  | -  |
...
| História de Usuário | [USB12](../modelagem/user_stories.md#USB12) |
| Caso de Uso | [Buscar Conteúdo](../modelagem/usecase.md#52-caso-de-uso-buscar-conteudo) |
| Cenário  | [C05](../modelagem/cenarios.md#c05-fazer-uma-pesquisa)  |
| Funcionalidade |<video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/buscar_conteudo.mkv" type="video/mp4"></video> |
...
| História de Usuário | [USB13](../modelagem/user_stories.md#USB13) |
| Caso de Uso | - |
| Cenário  | -  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/consulta_bits.mkv" type="video/mp4"></video>|
...
| História de Usuário | [USB23](../modelagem/user_stories.md#USB23) |
| Caso de Uso | - |
| Cenário  | -  |
| Funcionalidade |<video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/personalizar_perfil.mkv" type="video/mp4"></video> |
...
| Épico  | [EP02 - Conta](../modelagem/backlog.md#312-ep02-conta) |
| Feature | [Personalizar](../modelagem/lexico.md#l15-personalizar) perfil |
| História de Usuário | [USB24](../modelagem/user_stories.md#USB24) |
| Caso de Uso | - |
| Cenário  | -  |
...
| Épico  | [EP02 - Conta](../modelagem/backlog.md#312-ep02-conta) |
| Feature | [Personalizar](../modelagem/lexico.md#l15-personalizar) perfil |
| História de Usuário | [USB25](../modelagem/user_stories.md#USB25) |
| Caso de Uso | - |
| Cenário  | -  |
...
| Épico  | [EP02 - Conta](../modelagem/backlog.md#312-ep02-conta) |
| Feature |[Personalizar](../modelagem/lexico.md#l15-personalizar) perfil  |
| História de Usuário | [USB26](../modelagem/user_stories.md#USB26) |
| Caso de Uso | - |
...
| Épico  | [EP02 - Conta](../modelagem/backlog.md#312-ep02-conta) |
| Feature |[Personalizar](../modelagem/lexico.md#l15-personalizar) perfil  |
| História de Usuário | [USB27](../modelagem/user_stories.md#USB27) |
| Caso de Uso | - |
| Cenário  | -  |
...
| Épico  | [EP02 - Conta](../modelagem/backlog.md#312-ep02-conta) |
| Feature |[Personalizar](../modelagem/lexico.md#l15-personalizar) perfil  |
| História de Usuário | [USB28](../modelagem/user_stories.md#USB28) |
| Caso de Uso | - |
| Cenário  | -  |
...
| História de Usuário | [USB33](../modelagem/user_stories.md#USB33) |
| Caso de Uso | - |
| Cenário  | -  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/mudanca_idioma.mkv" type="video/mp4"></video>|
...
| História de Usuário | [USB35](../modelagem/user_stories.md#USB35) |
...
| História de Usuário | [USB36](../modelagem/user_stories.md#USB36) |
| Caso de Uso | - |
| Cenário  | -  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/logoff.mkv" type="video/mp4"></video>|
...
| História de Usuário | [USB37](../modelagem/user_stories.md#USB37) |
| Caso de Uso | - |
| Cenário  | -  |
...
| História de Usuário | [USB39](../modelagem/user_stories.md#USB39) |
| Caso de Uso | - |
| Cenário  | -  |
| Funcionalidade | <video style="width:50%" muted="" controls="" alt="type:video"><source src="../videos/personalizar_canal.mkv" type="video/mp4"></video> |
...
| História de Usuário | [USB40](../modelagem/user_stories.md#USB40) |
| Caso de Uso | [Criar Conteúdo](../modelagem/usecase.md#54-caso-de-uso-criar-conteudo) |
| Cenário  | -  |
...
| História de Usuário | [USB15](../modelagem/user_stories.md#USB15) |
| Caso de Uso | - |
| Cenário  | [C08](../modelagem/cenarios.md#c08-restricao-de-conteudo-18) |
| Funcionalidade |![sugestao_conteudo](../verifica_valida_grupo08/imagens/sugestao_conteudo.png) |

<h6 align = "center"> Tabela 23: Forward-From de Requisitos obtidos a partir de Observação
<br> Autor(es): Brunna Louise e Matheus Phillipo
<br> Fonte: Autor(es)</h6>
...
| Especificação Suplementar  | - |
| História de Usuário |[USB16](../modelagem/user_stories.md#USB16)  |
| Caso de Uso | - |
| Cenário  | [C08](../modelagem/cenarios.md#c08-restricao-de-conteudo-18)  |
...
| Especificação Suplementar  | - |
| História de Usuário | [USB17](../modelagem/user_stories.md#USB17) |
| Caso de Uso | - |
| Cenário  | [C08](../modelagem/cenarios.md#c08-restricao-de-conteudo-18)   |
| Funcionalidade | ![confirmacao_conteudo](./imagens/confirmacao_conteudo.png)|
...
| **USBXX** |  Histórias de usuário identificadas no artefato de [Histórias de Usuário](../modelagem/user_stories.md#3-historias-de-usuario).  |
| **EPXX** |  Épicos identificados no artefato de [Backlog](../modelagem/backlog.md#3-epicos).  |
| **CXX** |  Cenários implementados descritos no artefato de [Cenários](../modelagem/cenarios.md#31-cenarios-identificados-implementados).  |
| **OBSXX** |  Requisitos obtidos a partir da [técnica de Observação](../elicitacao/tecnicas/observacao.md#3-resultados).  |

<h6 align = "center"> Tabela 26: Legenda das siglas utilizadas ao longo do artefato.
<br> Autor(es): Brunna Louise e Matheus Phillipo
<br> Fonte: Autor(es)</h6>
...
<h6 align = "center"> Tabela 27: Histórico de Versões
<br> Autor(es): Brunna Louise e Matheus Phillipo
<br> Fonte: Autor(es)</h6>